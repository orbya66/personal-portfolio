...
export function HUDFrame({ children, className = '', scanline = true }) {
  return (
    <div className={`relative ${className}`}>
      ...
      {scanline ? <div className="absolute left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-[#FF4D00]/50 to-transparent animate-scan" /> : null}
